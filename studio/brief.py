...
Angle = Literal[
    ...
    "段子",  # v0.56: 反讽 / 自嘲 / 夸张戏谑 / 玩梗 voice
    "科普",  # v0.57: 知识点科普（教程=怎么做 / 科普=是什么 为什么）
    "避雷",  # v0.57: 反推荐 / 踩过的坑（痛点=共鸣 / 避雷=主动警告）
    "测评",  # v0.57: 横向打分（工具评测=单品深度 / 测评=多产品横评）
    # v0.61.22 新增 5 个常用角度 ：
    "盘点",  # 「N 件 X 合集」「年度盘点」— 列表型 hook 之外的策展感
    "复盘",  # 「阶段性回顾」「失败/成功复盘」— 比感悟更结构化，重数据
    "问答",  # 「网友常问 / 答疑」— 答题型 hook，互动强
    "打卡",  # 「day N」「月度打卡」— 健身/学习/穿搭日记型
    "教训",  # 「我花 X 万学到的」「血泪经验」— 比避雷更深刻 + 有成本
]
